...
public class PersonsInAMonthWeek {
    ...
    public PersonsInAMonthWeek(
            final LocalDate mondayDate, final List<Person> mondayPersons,
            final LocalDate tuesdayDate, final List<Person> tuesdayPersons,
            final LocalDate wednesdayDate, final List<Person> wednesdayPersons,
            final LocalDate thursdayDate, final List<Person> thursdayPersons,
            final LocalDate fridayDate, final List<Person> fridayPersons,
            final LocalDate saturdayDate, final List<Person> saturdayPersons,
            final LocalDate sundayDate, final List<Person> sundayPersons) {
    ...
    public static List<PersonsInAMonthWeek> parseMonth(final List<Person> persons, final YearMonth targetMonth) {
        ...
        final LocalDate firstWeekStart = firstDayOfMonth.minusDays(firstDayOfMonth.getDayOfWeek().getValue() - DayOfWeek.MONDAY.getValue());
        final LocalDate lastWeekEnd = lastDayOfMonth.plusDays(DayOfWeek.SUNDAY.getValue() - lastDayOfMonth.getDayOfWeek().getValue());

        for (LocalDate weekStart = firstWeekStart; !weekStart.isAfter(lastWeekEnd); weekStart = weekStart.plusWeeks(1)) {
            monthWeeks.add(new PersonsInAMonthWeek(
                    dateIfInsideMonth(weekStart, targetMonth), personsOnDate(weekStart, targetMonth, personsByDate),
                    dateIfInsideMonth(weekStart.plusDays(1), targetMonth), personsOnDate(weekStart.plusDays(1), targetMonth, personsByDate),
                    dateIfInsideMonth(weekStart.plusDays(2), targetMonth), personsOnDate(weekStart.plusDays(2), targetMonth, personsByDate),
                    dateIfInsideMonth(weekStart.plusDays(3), targetMonth), personsOnDate(weekStart.plusDays(3), targetMonth, personsByDate),
                    dateIfInsideMonth(weekStart.plusDays(4), targetMonth), personsOnDate(weekStart.plusDays(4), targetMonth, personsByDate),
                    dateIfInsideMonth(weekStart.plusDays(5), targetMonth), personsOnDate(weekStart.plusDays(5), targetMonth, personsByDate),
                    dateIfInsideMonth(weekStart.plusDays(6), targetMonth), personsOnDate(weekStart.plusDays(6), targetMonth, personsByDate)));
        }
    ...
    private static List<Person> personsOnDate(final LocalDate date, final YearMonth targetMonth, final Map<LocalDate, List<Person>> personsByDate) {
        if (!YearMonth.from(date).equals(targetMonth)) {
            return List.of();
        }
