...
public class MonthTableCallback implements Callback<TableColumn.CellDataFeatures<PersonsInAMonthWeek, String>, ObservableValue<String>> {
    ...
    @Override
    public ObservableValue<String> call(final TableColumn.CellDataFeatures<PersonsInAMonthWeek, String> monthDate) {
