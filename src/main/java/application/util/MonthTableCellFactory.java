...
public class MonthTableCellFactory
    implements Callback<
        TableColumn<PersonsInAMonthWeek, String>, TableCell<PersonsInAMonthWeek, String>> {
  ...
  @Override
  public TableCell<PersonsInAMonthWeek, String> call(
      final TableColumn<PersonsInAMonthWeek, String> param) {
