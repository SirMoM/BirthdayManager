...
public class SearchViewController extends Controller {
          ...
          for (Person person : PersonManager.getInstance().getPersons()) {
            ...
            boolean surname =
                person.getSurname() != null
                    && LevenshteinDistanz.calculate(person.getSurname().toUpperCase(), searchString)
                        <= 2;
            boolean name =
                person.getName() != null
                    && LevenshteinDistanz.calculate(person.getName().toUpperCase(), searchString)
                        <= 2;
            boolean misc =
                person.getMisc() != null
                    && LevenshteinDistanz.calculate(person.getMisc().toUpperCase(), searchString)
                        <= 2;
  ...
  protected boolean contains(final Person person, final String searchText) {
    String searchString = searchText.toUpperCase();
    boolean surname =
        person.getSurname() != null && searchString.contains(person.getSurname().toUpperCase());
    boolean name =
        person.getName() != null && searchString.contains(person.getName().toUpperCase());
    boolean misc =
        person.getMisc() != null && searchString.contains(person.getMisc().toUpperCase());
