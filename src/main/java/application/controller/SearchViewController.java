...
public class SearchViewController extends Controller {
  ...
  private final EventHandler<ActionEvent> returnToPreviousView =
      actionEvent -> SearchViewController.this.getMainController().goToLastScene();

  @FXML private Label search_Label;
  @FXML private TextField searchText_TextField;
  @FXML private Button search_Button;
  @FXML private TitledPane advancedSettings_TitledPane;
  @FXML private DatePicker dateSearch_DatePicker;
  private final EventHandler<ActionEvent> searchDateEventHandler =
      event -> {
        ...
        for (Person person : PersonManager.getInstance().getPersons()) {
          ...
          boolean start =
              birthdayThisYear.isAfter(
                  SearchViewController.this.dateSearch_DatePicker.getValue().minusDays(6));
          boolean end =
              birthdayThisYear.isBefore(
                  SearchViewController.this.dateSearch_DatePicker.getValue().plusDays(6));
  ...
  @FXML private RadioButton enableFuzzy_RadioButton;
  @FXML private RadioButton enableRegEx_RadioButton;
  private final EventHandler<Event> searchEventHandler =
      event -> {
            ...
            boolean surname =
                person.getSurname() != null
                    && LevenshteinDistance.calculate(
                            person.getSurname().toUpperCase(), searchString)
                        <= 2;
            boolean name =
                person.getName() != null
                    && LevenshteinDistance.calculate(person.getName().toUpperCase(), searchString)
                        <= 2;
            boolean misc =
                person.getMisc() != null
                    && LevenshteinDistance.calculate(person.getMisc().toUpperCase(), searchString)
                        <= 2;
  ...
  private final EventHandler<ActionEvent> switchFuzzyRegExEventHandler =
      event -> {
        if (event.getSource() instanceof RadioButton) {
          RadioButton radioButtonSource = (RadioButton) event.getSource();
          if (radioButtonSource.isSelected()
              && radioButtonSource.getId().equals(enableFuzzy_RadioButton.getId())) {
  ...
  @FXML private Button dateSearch_Button;
  @FXML private ListView<Person> searchResults_ListView;
  final EventHandler<ActionEvent> openBirthday =
      event -> {
        final ObservableList<Person> selectedItems =
            SearchViewController.this.searchResults_ListView.getSelectionModel().getSelectedItems();
  ...
  @FXML private Button openBirthday_Button;
  @FXML private Button closeSearch_Button;
  ...
  protected boolean contains(final Person person, final String searchText) {
    String searchString = searchText.toUpperCase();
    boolean surname =
        person.getSurname() != null && person.getSurname().toUpperCase().contains(searchString);
    boolean name =
        person.getName() != null && person.getName().toUpperCase().contains(searchString);
    boolean misc =
        person.getMisc() != null && person.getMisc().toUpperCase().contains(searchString);
  ...
  protected boolean match(final Person person, final String searchText) {
    ...
    boolean surname =
        person.getSurname() != null && pattern.matcher(person.getSurname().toLowerCase()).find();
    boolean name =
        person.getName() != null && pattern.matcher(person.getName().toLowerCase()).find();
    boolean misc =
        person.getMisc() != null && pattern.matcher(person.getMisc().toLowerCase()).find();
  ...
  private void assertion() {
    assert search_Label != null
        : "fx:id=\"search_Label\" was not injected: check your FXML file 'SearchView.fxml'.";
    assert searchText_TextField != null
        : "fx:id=\"searchText_TextField\" was not injected: check your FXML file 'SearchView.fxml'.";
    assert search_Button != null
        : "fx:id=\"search_Button\" was not injected: check your FXML file 'SearchView.fxml'.";
    assert advancedSettings_TitledPane != null
        : "fx:id=\"advancedSettings_TitledPane\" was not injected: check your FXML file 'SearchView.fxml'.";
    assert dateSearch_DatePicker != null
        : "fx:id=\"dateSearch_DatePicker\" was not injected: check your FXML file 'SearchView.fxml'.";
    assert enableFuzzy_RadioButton != null
        : "fx:id=\"enableFuzzy_RadioButton\" was not injected: check your FXML file 'SearchView.fxml'.";
    assert enableRegEx_RadioButton != null
        : "fx:id=\"enableRegEx_RadioButton\" was not injected: check your FXML file 'SearchView.fxml'.";
    assert dateSearch_Button != null
        : "fx:id=\"dateSearch_Button\" was not injected: check your FXML file 'SearchView.fxml'.";
    assert searchResults_ListView != null
        : "fx:id=\"searchResults_ListView\" was not injected: check your FXML file 'SearchView.fxml'.";
    assert openBirthday_MenuItem != null
        : "fx:id=\"openBirthday_MenuItem\" was not injected: check your FXML file 'SearchView.fxml'.";
    assert openBirthday_Button != null
        : "fx:id=\"openBirthday_Button\" was not injected: check your FXML file 'SearchView.fxml'.";
    assert closeSearch_Button != null
        : "fx:id=\"closeSearch_Button\" was not injected: check your FXML file 'SearchView.fxml'.";
  }
  ...
  private void bindComponents() {
    ...
    this.enableFuzzy_RadioButton.addEventHandler(
        ActionEvent.ANY, this.switchFuzzyRegExEventHandler);
    this.enableRegEx_RadioButton.addEventHandler(
        ActionEvent.ANY, this.switchFuzzyRegExEventHandler);
    ...
    this.searchResults_ListView.addEventHandler(
  ...
  public void updateLocalisation() {
    ...
    this.enableFuzzy_RadioButton.setText(
        lrm.getLocaleString(LangResourceKeys.enableFuzzy_RadioButton));
    this.enableRegEx_RadioButton.setText(
        lrm.getLocaleString(LangResourceKeys.enableRegEx_RadioButton));
    this.dateSearch_Button.setText(lrm.getLocaleString(LangResourceKeys.search));
    this.openBirthday_MenuItem.setText(lrm.getLocaleString(LangResourceKeys.openBirthday_MenuItem));
    this.advancedSettings_TitledPane.setText(
        lrm.getLocaleString(LangResourceKeys.advancedSettings_TitledPane));
