...
public class EditBirthdayViewController extends Controller {
  ...
  private final EventHandler<ActionEvent> savePersonHandler =
      actionEvent -> {
        ...
        try {
          ...
          if (!middleNameFromTextField.matches(
              EditBirthdayViewController.this.personToEdit.getMisc())) {
            anyChangeAtAll = true;
          }
          if (!surnameFromTextfield.matches(
              EditBirthdayViewController.this.personToEdit.getSurname())) {
            anyChangeAtAll = true;
          }
          if (EditBirthdayViewController.this.birthday_DatePicker.getValue()
              != EditBirthdayViewController.this.personToEdit.getBirthday()) {
            anyChangeAtAll = true;
          }
        ...
        if (anyChangeAtAll) {
          ...
          PersonManager.getInstance()
              .updatePerson(EditBirthdayViewController.this.indexPerson, updatedPerson);
  ...
  private final EventHandler<ActionEvent> exitHandler =
      event -> EditBirthdayViewController.this.getMainController().goToBirthdaysOverview();
