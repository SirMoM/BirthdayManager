...
public class EditBirthdayViewController extends Controller {
  private static final Logger LOG =
      LogManager.getLogger(EditBirthdayViewController.class.getName());

  private final Person personToEdit;
  private final EventHandler<ActionEvent> exitHandler =
      event -> EditBirthdayViewController.this.getMainController().goToLastScene();
  ...
  private final EventHandler<ActionEvent> savePersonHandler =
      actionEvent -> {
        ...
        final String middleNameFromTextField =
            EditBirthdayViewController.this.middleName_TextField.getText();
        final String surnameFromTextfield =
            EditBirthdayViewController.this.surname_TextField.getText();
        final LocalDate birthdayFromDatePicker =
            EditBirthdayViewController.this.birthday_DatePicker.getValue();
        final Person updatedPerson =
            new Person(
                surnameFromTextfield,
                nameFromTextField,
                middleNameFromTextField,
        ...
        if (hasChanges(EditBirthdayViewController.this.personToEdit, updatedPerson)) {
          ...
          PersonManager.getInstance()
              .updatePerson(EditBirthdayViewController.this.personToEdit, updatedPerson);
          EditBirthdayViewController.this.getMainController().goToLastScene();
        }
        if (Boolean.parseBoolean(PropertyManager.getProperty(PropertyFields.WRITE_THRU))) {
          SaveBirthdaysToFileTask task =
   ...
   */
  public EditBirthdayViewController(
      final MainController mainController, final Person personToEdit) {
  ...
  private void assertions() {
    ...
    assert identifyingPerson_label != null
