...
class UpdateBirthdaysThisMonthTaskTest {
    ...
    void call_IncludesOnlyBirthdaysOfTheRequestedMonth() throws Exception {
        ...
        PersonManager.getInstance().setPersonDB(List.of(firstBirthday, secondBirthday, endOfMonthBirthday, nextMonthBirthday));

        UpdateBirthdaysThisMonthTask classToTest = new UpdateBirthdaysThisMonthTask(YearMonth.of(2026, 3));
