...
class BirthdaysOverviewControllerTest {
  ...
  void findMonthWeekIndexForDate_ReturnsMatchingWeekRow() {
    ...
    List<PersonsInAMonthWeek> monthWeeks =
        List.of(
    ...
    int index =
        BirthdaysOverviewController.findMonthWeekIndexForDate(
            monthWeeks, LocalDate.of(2026, 3, 17));
  ...
  void findMonthWeekIndexForDate_ReturnsMinusOneWhenDateIsMissing() {
    LocalDate monday = LocalDate.of(2026, 3, 2);
    List<PersonsInAMonthWeek> monthWeeks =
        List.of(monthWeekStartingAt(monday), monthWeekStartingAt(monday.plusWeeks(1)));

    int index =
        BirthdaysOverviewController.findMonthWeekIndexForDate(monthWeeks, LocalDate.of(2026, 4, 1));
  ...
  @Test
  void shouldHandleOverviewTabShortcut_ReturnsTrueForTabWhenOverviewSceneIsActive() {
    boolean shouldHandleShortcut =
        BirthdaysOverviewController.shouldHandleOverviewTabShortcut(KeyCode.TAB, true);

    assertThat(shouldHandleShortcut).isTrue();
  }

  @Test
  void shouldHandleOverviewTabShortcut_ReturnsFalseWhenOverviewSceneIsInactive() {
    boolean shouldHandleShortcut =
        BirthdaysOverviewController.shouldHandleOverviewTabShortcut(KeyCode.TAB, false);

    assertThat(shouldHandleShortcut).isFalse();
  }
