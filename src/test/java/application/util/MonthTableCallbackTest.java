...
class MonthTableCallbackTest {
    ...
    void call_FormatsDateAndBirthdaysForTheConfiguredDay() {
        ...
        PersonsInAMonthWeek monthWeek = new PersonsInAMonthWeek(
                LocalDate.of(2026, 3, 2), List.of(firstBirthday, secondBirthday),
                null, List.of(),
                null, List.of(),
                null, List.of(),
                null, List.of(),
        ...
        ObservableValue<String> value = callback.call(new TableColumn.CellDataFeatures<>(
                null,
                null,
                monthWeek));
